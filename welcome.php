   ...
   if(isset($_GET['pkbooksid']))
   {
	   ...
	   foreach($selectQ as $getSingleRec);
	   {
           ...
           <div class=" center">
               ...
               <h5 class="card-title"><?php echo $getSingleRec['title']; ?></h5>
               <p class="card-text"><?php echo $getSingleRec['publishby']; ?></p>
	   ...
	   if(isset($_GET['loadform']))
	   {
			if(!isset($_SESSION['signin']) || $_SESSION['signin']!=true) //check session
			{
				echo '<!doctype html>
					...
					<body>
							<p>For create a post please sign in or Sign up</p>
					...
					<form method="post" action="insert.php">
						<div class="container">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="publishby" name="publishby" value="<?php echo $_SESSION['name']; ?>" placeholder="Enter publisher name">
							</div>
							<div class="form-group">
